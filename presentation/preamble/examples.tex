...
\newcommand{\exghost}{\refstepcounter{exampleno}}
...
{
	\begin{tabular}{p{0.50\linewidth}!{\color{gray}\vrule}p{0.42\linewidth}}
		{#2} &
		{\fontspec[AutoFakeBold=3, Mapping=ehll]{Gentium}#3}\\\\
		{{\small #4}} &
