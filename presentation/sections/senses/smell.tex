...
\begin{frame}{\ex \bh{hērīaḥ} ‘to smell’ → \C{arogli}}
...
\begin{frame}{\ex \bh{hērīaḥ} ‘to smell’ → \C{cyffwꝛdd}}
...
\begin{frame}{\ex \bh{hērīaḥ} ‘to smell’→ \C{deall}}
...
\begin{frame}{\ex \bh{rēaḥ} ‘smell’ (noun) → \C{arogl}}
...
\begin{frame}{\ex \bh{rēaḥ nīḥōaḥ} ‘pleasant smell’ → \C{arogl esmwyth}}
