...
\begin{frame}{\ex\ Inability of idols \hfill (Ps.~115:4–7) [1/2]}
	\begin{example}{Ps.}{115}{4–5}{}{}
		...
		{%
			...
			pɛ·l·åhɛm wə·lō \hlA{yəḏabbērū} ʿēnayim l·åhɛm wə·lō \hlA{yirʾū}
		}
		{%
...
\begin{frame}{\excont\ Inability of idols \hfill (Ps.~115:4–7) [2/2]}
	\begin{example}{Ps.}{115}{6–7}{}{}
		...
		{%
			ʾåznayim l·åhɛm wə·lō \hlA{yišmåʿū} ʾap̄ l·åhɛm wə·lō \hlA{yərīḥūn} |
			yəḏēhɛm wə·lō \hlA{yəmīšūn} raḡlēhɛm wə·lō \hlA{yəhallēḵū} lō·\hlA{yɛhgū} bi·ḡrōnåm
		}
		{%
	...
	\begin{center}
		\scalebox{0.75}{
			\begin{tikzpicture}[text width=\widthof{gwrando}, align=center]
				\node at (0, 0) [circle,draw, line width = 2pt] (X) {{{\Large\bh{råʾå}}}};
