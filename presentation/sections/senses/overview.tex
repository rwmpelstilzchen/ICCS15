...
\begin{frame}{\ex Inability of idols \hfill (\bcite{Deut.}{4}{28})}
...
\begin{frame}{\ex Inability of idols \hfill (\bcite{Ps.}{115}{4–7}) [1/2]}
	\begin{example}{Ps.}{115}{4–5}{}{}
		\quoling
		{%
			עֲצַבֵּיהֶם כֶּ֣סֶף וְזָהָ֑ב מַ֝עֲשֵׂ֗ה יְדֵ֣י אָדָֽם׃
			פֶּֽה־לָ֭הֶם וְלֹ֣א \hlA{יְדַבֵּ֑רוּ} עֵינַ֥יִם לָ֝הֶ֗ם וְלֹ֣א \hlA{יִרְאֽוּ}׃
		}
		{%
...
\begin{frame}{\excont\ Inability of idols \hfill (\bcite{Ps.}{115}{4–7}) [2/2]}
	\begin{example}{Ps.}{115}{6–7}{}{}
		\quoling
		{%
			אָזְנַ֣יִם לָ֭הֶם וְלֹ֣א \hlA{יִשְׁמָ֑עוּ} אַ֥ף לָ֝הֶ֗ם וְלֹ֣א \hlA{יְרִיחֽוּן}׃
			יְדֵיהֶ֤ם ׀ וְלֹ֬א \hlA{יְמִישׁ֗וּן} רַ֭גְלֵיהֶם וְלֹ֣א \hlA{יְהַלֵּ֑כוּ} לֹֽא־\hlA{יֶ֝הְגּ֗וּ} בִּגְרוֹנָֽם׃
		}
		{%
...
\begin{frame}{\ex Inability of idols \hfill (\bcite{Ps.}{4}{28})}
	\begin{example}{Ps.}{135}{16–17}{}{}
		\quoling
		{%
			פֶּֽה־לָ֭הֶם וְלֹ֣א יְדַבֵּ֑רוּ עֵינַ֥יִם לָ֝הֶ֗ם וְלֹ֣א \hlA{יִרְאֽוּ}׃\ %
			אָזְנַ֣יִם לָ֭הֶם וְלֹ֣א \hlA{יַאֲזִ֑ינוּ} אַ֝֗ף אֵין־יֶשׁ־ר֥וּחַ בְּפִיהֶֽם׃
		}
		{%
			Genau [ſydd] iddynt, ac ni lefarant: llygaid [ſydd] ganddynt, ac ni \hlA{welant}.\ %
			[Y mae] cluſtiau iddynt, ac ni \hlA{chlywant}: nid oes ychwaith anadl yn eu genau.
		}
		{%
			pɛ-lå̄hɛm wə-lō yəḏabbērū ʿēnayim lå̄hɛm wə-lō \hlA{yirʾū}\ %
			ʾå̄znayim lå̄hɛm wə-lō \hlA{yaʾăzīnū} ʾap̄ ʾēn-yɛš-rūaḥ bə-p̄īhɛm
		}
		{%
			They have mouths, but they speak not; eyes have they, but they \hlA{see} not;\ %
			They have ears, but they \hlA{hear} not; neither is there any breath in their mouths.
		}
	\end{example}
\end{frame}

\exghost\exghost\exghost\exghost\exghost
...
\begin{frame}{\C{gweled}:\C{edrych} and \C{clywed}:\C{gwrando}}
	\begin{center}
		...
		\scalebox{0.75}{
			\begin{tikzpicture}[text width=\widthof{gwrando}, align=center]
				\node at (0, 0) [circle,draw, line width = 2pt] (X) {{{\Large\bh{šå̄maʿ}}}};
...
\begin{frame}{\hopoint\C{gweled} and \C{clywed}}
	\begin{itemize}
		\item semantically unmarked concerte sensory perception
		\item perception of content
		%-%\item understanding (\C{gweled} only)
	\end{itemize}
\end{frame}


\begin{frame}{\hopointcont\C{edrych} and \C{gwrando}}
	\begin{description}
		\item [\C{edrych}:] ~
			\begin{itemize}
				\item facing
