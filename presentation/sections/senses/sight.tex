...
\sepslide{\bh{rå̄ʾå̄} being translated by \C{gweled}}
...
\sepslide{\bh{rå̄ʾå̄} being translated by \C{edrych}}
...
\begin{frame}{\ex Looking (Moses looking at the bush)}
...
\begin{frame}{\ex Scouting out (retrospection)}
...
\sepslide{\bh{rå̄ʾå̄} being translated by \C{canfod}}

\begin{frame}{\ex Coming across something}
...
\begin{frame}{\hopoint Types of translational relationships}
	\begin{itemize}
		\item Simple, no or very little variance (\typeC):
			\bh{hɛrʾå̄}, \bh{nirʾå̄}, \bh{hibbīṭ}, \bh{ḥå̄zå̄}, \bh{hišqīp̄}, \bh{hišgīaḥ},
			\bh{rōʾɛ}, \bh{ḥōzɛ}
