...
\begin{frame}{\bh{pånå} ‘to turn, to face, to look’}
	\begin{center}
		$$
...
\begin{frame}{\bh{pånå} being translated by \C{edrych}}
	\begin{itemize}
...
\begin{frame}{\exwref \bh{pånå} → \C{edrych} (looking)}
	\exstep
...
\begin{frame}{\exwref \bh{pånå} → \C{edrych} (accepting or willing)}
	\exstep
...
\begin{frame}{\exwref \bh{pånå} → \C{edrych} (geographical direction)}
	\exstep
...
\begin{frame}{\bh{pånå} being translated by \C{troi}}
	\begin{itemize}
...
\begin{frame}{\exwref \bh{pånå} → \C{troi} (physical sense)}
	\exstep
...
\begin{frame}{\exwref \bh{pånå} → \C{troi} (metaphorically)}
	\exstep
...
\begin{frame}{\bh{ḥåzå} ‘to see, to prophesy’}
	\begin{center}
		$$
...
\begin{frame}{\ex \bh{råʾå} and \bh{ḥåzå}, lexical differentiation}
