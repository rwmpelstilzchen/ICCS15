...
\begin{frame}{Celtic and Afro-Asiatic}
	\begin{center}
		\fbox{\includegraphics[width=0.66\textwidth]{OrteliusWorldMap1570.jpg}}
...
\begin{frame}{Textual Substratum}
	\LR{\includegraphics[width=6.273cm]{ex_24-7.cy.png}}
	\hfill
	\LR{\includegraphics[width=3.25125cm]{ex_24-7.he.png}}
...
\begin{frame}{1588 Welsh Bible}
	\begin{center}
		\fbox{{\includegraphics[height=4cm]{Morgan.jpg}}}
...
\begin{frame}{Dispersing light, dispersing language}
	\begin{center}
		\fbox{\includegraphics[width=0.66\textwidth]{Newton.jpg}}
...
\begin{frame}{Corpus}
	\begin{center}
		\begin{tabular}{ccc}
			\fbox{\includegraphics[height=6cm]{1588.jpg}}
			\\
...
\begin{frame}{Corpus}
	\begin{center}
		\begin{tabular}{ccc}
			\fbox{\includegraphics[height=4cm]{1588.jpg}}
			&
			\phantom{\fbox{\includegraphics[height=4cm]{1611.cropped.jpg}}}
			&
			\fbox{\includegraphics[height=4cm]{1620.cropped.png}}
			\\
			{\scriptsize 1588 Welsh translation}
			&
...
\begin{frame}{Corpus}
	\begin{center}
		\begin{tabular}{ccc}
			\fbox{\includegraphics[height=4cm]{1588.jpg}}
			&
			\fbox{\includegraphics[height=4cm]{1611.cropped.jpg}}
			&
			\fbox{\includegraphics[height=4cm]{1620.cropped.png}}
			\\
			{\scriptsize 1588 Welsh translation}
...
% 		{\highlight{way-yišmaʿ} mōšɛ ʾɛṯ-hå-ʿåm bōḵɛ lə-mišpəḥōṯåw ʾīš lə-p̄ɛṯaḥ ʾåhå̄̆lō way-yiḥar-ʾap̄ {\YHWH} məʾōḏ ū-ḇ-ʿēnē mōšɛ råʿ}
...
% 	\begin{multicols}{2}
% 		\begin{center}
% 			\fbox{{\includegraphics[height=2.5cm]{SFClassicsHjelmslev.mirrored.jpeg}}}
% 			
% 			{\scriptsize Louis Hjelmslev (1899–1965)}
% 		\end{center}
% 
% 		{\scriptsize\setstretch{0.05} The objects of interest to linguistic theory are texts. The aim of linguistic theory is to provide a procedural method by means of which a given text can be comprehended through a self-consistent and exhaustive description.
% 
% 		\tiny\setstretch{0.05} (from \textit{Prolegomena to a Theory of Language})}
% 		
% 		\begin{center}
% 			\fbox{{\includegraphics[height=2.5cm]{saussure.png}}}
% 
% 			{\scriptsize Ferdinand de Saussure (1857–1913)}
% 		
% 			\vfill
% 
% 			{{\includegraphics[height=2cm]{arbor.png}}}
% 		\end{center}
% 	\end{multicols}
% \end{frame}
% 
...
% \begin{frame}{Conclusion}
% 	\begin{center}
% 		\fbox{{\includegraphics[height=5cm]{Morgan.jpg}}}
% 	\end{center}
% \end{frame}
