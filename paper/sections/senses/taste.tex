...
\begin{paper}
	The main verb translating \bh{ṭå̄ʿam} ‘to taste’ is \C{archwaithu}. Twice it is translated by \C{profi} and in one case, when \bh{ṭå̄ʿam} is used figuratively with a content complement, it is rendered as \C{gweled}, which is probably more suitable for the Welsh idiomatics.
\end{paper}
...
\begin{compactdesc}\small
	\item [Vulgate:] \lhl{gustavit} quia bona est negotiatio eius non extinguetur in nocte lucerna illius
	\item [Geneva:] She \lhl{feeleth} that her marchandise is good: her candle is not put out by night.
	\item [Bishops’:] And yf she \lhl{perceaue} that her huswiferie doth good, her candell goeth not out by nyght.
\end{compactdesc}
...
\begin{paper}
	Another word of the same root is the pluralis tantum verb \bh{maṭʿammīm} ‘delicacies’, which is translated by \C{dainteithion}.
\end{paper}
