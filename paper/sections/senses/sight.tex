...
\begin{example}{Num.}{13}{18}{}{}
	...
	{ū·\lhl{rʾīṯɛm} ʾɛṯ·hå·ʾårɛṣ ma·hī wə·ʾɛṯ·hå·ʿåm hay·yōšēḇ ʿålɛhå hɛ·ḥåzåq hū hă·råp̄ɛ ha·mʿaṭ hū ʾim·råḇ}
...
\begin{example}{Num.}{32}{8}{}{}
	...
	{kō ʿåśū ʾăḇōṯēḵɛm bə·šålḥī ʾōṯå·m miq·qåḏēš barnēaʿ li·\lhl{rʾōṯ} ʾɛṯ·hå·ʾårɛṣ}
...
\begin{paper}
	Now let’s, well, turn to another verb, \bh{pånå}, which has the same root of the noun \bh{pånīm} ‘a face’. It is translated mostly using \C{edrych} (comparable here with English \textit{to face} to a certain degree) or \C{troi} ‘to turn’. This distinction is not expressed in the original Hebrew text using lexically, and Morgan had to choose in each occurance of \bh{pånå} whether to use the one or the other, or in fewer cases a completely different verb.
\end{paper}
...
\begin{paper}
	While the Hebrew verb \bh{nibbå̄} ‘to prophesy’ has a narrower meaning, \bh{ḥåzå} can mean ‘to prophesy’ but also broader ‘to see’. I almost all cases it is translated by \C{gweled}, even when the meaning is obviously not a simple visual ‘seeing’.

	The derived noun \bh{ḥōzɛ} ‘a seer, a prophet’ is translated \C{gweledudd} in almost all cases.
\end{paper}
