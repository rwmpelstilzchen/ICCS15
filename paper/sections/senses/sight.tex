...
\subsubsectionoccurances[\bh{šå̄r}]{\bh{šå̄r} ‘to behold’}{23}
...
\begin{hopoint}
	\begin{compactitem}
		\item Most show simple conversion, with very little or no variation:
			\bh{hɛrʾå̄}→\C{dangos} and \bh{nirʾå̄}→\C{ymddangos} (the causative and passive of \bh{rå̄ʾå̄}), \bh{hibbīṭ}→\C{edrych}, \bh{ḥå̄zå̄}→\C{gweled}}, \bh{hišgīaḥ}→\C{edrych}, \bh{rōʾɛ}→\C{gweledudd} and \bh{ḥōzɛ}→\C{gweledudd}.
