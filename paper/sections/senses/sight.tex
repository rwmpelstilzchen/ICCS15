...
\begin{paper}
	While the Hebrew verb \bh{nibbå̄} ‘to prophesy’ has a narrower meaning, \bh{ḥå̄zå̄} can mean ‘to prophesy’ but also broader ‘to see’. I almost all cases it is translated by \C{gweled}, even when the meaning is obviously not a simple visual ‘seeing’.

	Both \bh{ḥōzɛ} and \bh{rōʾɛ}, meaning ‘a seer’ in the sense of ‘a prophet’ are translated \C{gweledudd} in almost all cases; they are derived from \bh{ḥå̄zå̄} and \bh{rå̄ʿå̄}
\end{paper}
