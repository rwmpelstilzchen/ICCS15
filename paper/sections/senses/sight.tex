...
\begin{paper}
	...
	As I’ve said \C{gweled} in this opposition is used for simple concrete visual perception, perception of content, and for seeing as understanding, while \C{edrych} is used in the sense of facing, looking at and looking for, accepting, examining, inspecting, etc.
...
\begin{paper}
	So for \C{gweled} there is visual perception, perception of content and seeing as understanding.
\end{paper}
...
\begin{paper}
	Exx.~\vref{Gen.}{13}{14}{} and \vref{Ex.}{3}{4}{} are examples for \bh{rå̄ʾå̄} in the sense of ‘looking’.
\end{paper}
...
\begin{paper}
	I will use \exvref{Isa.}{30}{10}{} to demonstrate an interesting phenomenon, a further discussion thereof you can see the at the ‘Further research’ section on the handout. It is well known that the Biblical language, both in prose and poetry, is fond of \hl{parallelisms}, saying the same thing twice in a different manner for rhetoric purposes. In this example Morgan avoids repetition of the same word translating both \bh{rå̄ʾå̄} and \bh{ḥå̄zå̄}, and changes \bh{ḥå̄zå̄} into \C{canfod} in order to retain \hl{lexical differentiation}. He doesn’t always do that, but it is certainly a feature of his translation practice and as such requires scholarly attention and description.
\end{paper}
...
\begin{paper}
	{\click} If \bh{rå̄ʾå̄} and \bh{på̄nå̄} show limited lexical dispersion, to two just main lexemes each, and \bh{hibbīṭ} and \bh{ḥå̄zå̄} show uniformity, \bh{ṣå̄p̄å̄} ‘to watch’ and \bh{šå̄r} ‘to behold’ are more finely tuned according to meaning; for example \C{disgwil} is used in the sense of anticipation (\exvref{Lam.}{4}{17}{}) and negated \C{cael} is added to \C{gweled} when describing inability to see because of concealment (\exvref{Job}{24}{15}{}).
