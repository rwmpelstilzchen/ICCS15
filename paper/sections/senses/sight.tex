...
\subsubsectionoccurances{\bh{rå̄ʾå̄}}{381}
...
\subsubsectionoccurances{\bh{på̄nå̄}}{135}
...
\begin{example}{Ex.}{2}{12}{}{}
	...
	{way·\lhl{yīp̄ɛn} kō wå̄̄·ḵō way·yar kī ʾēn ʾīš way·yaḵ ʾɛṯ·ham·miṣrī wayyiṭmənēhū b·a·ḥōl}
...
\begin{example}{2 Chr.}{6}{19}{}{}
	...
	{ū·\lhl{p̄å̄̄nīṯå̄̄} \hlA{ʾɛl}·təp̄illaṯ ʿaḇdəḵå̄̄ wə·ʾɛl·təḥinnå̄̄ṯō {\YHWH} ʾɛ̆lōhå̄̄y li·šmōaʿ ʾɛl·hå̄̄·rinnå̄̄ wə·ʾɛl·hat·təp̄illå̄̄ ʾăšɛr ʿaḇdəḵå̄̄ miṯpallēl lə·p̄å̄̄nɛḵå̄̄}
...
\begin{example}{Ezek.}{43}{1}{}{}
	...
	{wayyōlīḵēnī ʾɛl·haš·šå̄̄ʿar šaʿar ʾăšɛr \lhl{pōnɛ} dɛrɛḵ haq·qå̄̄ḏīm}
...
\begin{example}{Gen.}{18}{22}{}{}
	...
	{way·\lhl{yip̄nū} miš·šå̄̄m hå̄̄·ʾănå̄̄šīm way·yēlḵū səḏōm·å̄̄ wə·ʾaḇrå̄̄hå̄̄m ʿōḏɛnnū ʿōmēḏ li·p̄nē {\YHWH}}
...
\begin{example}{Deut.}{31}{18}{}{}
	...
	{wə·ʾå̄̄nōḵī hastēr ʾastīr på̄̄nay b·ay·yōm ha·hū ʿal kå̄̄l·hå̄̄·rå̄̄ʿå̄̄ ʾăšɛr ʿå̄̄śå̄̄ kī \lhl{p̄å̄̄nå̄̄} ʾɛl·ʾɛ̆lōhīm ʾăḥērīm}
...
\subsubsectionoccurances{\bh{ḥå̄zå̄}}{53}

\begin{paper}
	While the Hebrew verb \bh{nibbå̄̄} ‘to prophesy’ has a narrower meaning, \bh{ḥå̄zå̄} can mean ‘to prophesy’ but also broader ‘to see’. I almost all cases it is translated by \C{gweled}, even when the meaning is obviously not a simple visual ‘seeing’.

	The derived noun \bh{ḥōzɛ} ‘a seer, a prophet’ is translated \C{gweledudd} in almost all cases, which is the same lexeme used for translating \bh{rōʾɛ}***.
\end{paper}
...
\begin{example}{Isa.}{2}{1}{}{}
	...
	{had·då̄̄ḇå̄̄r ʾăšɛr \lhl{ḥå̄̄zå̄̄} yəšaʿyå̄̄hū bɛn·ʾå̄̄mōṣ ʿal·yəhūḏå̄̄ wī·rūšå̄̄lå̄̄yim}
...
\begin{example}{Isa.}{30}{10}{}{}
	...
	{ʾăšɛr ʾå̄̄mrū l·å̄̄·\hlA{rōʾīm} lō \hlA{ṯirʾū} wə·l·a·\lhl{ḥōzīm} lō \lhl{ṯɛḥɛ̆zū}·lå̄̄nū nəḵōḥōṯ dabbərū·lå̄̄nū ḥălå̄̄qōṯ \lhl{ḥăzū} mahăṯallōṯ}
...
\subsubsectionoccurances{\bh{ṣå̄p̄å̄}}{36}
\subsubsectionoccurances{\bh{šå̄r}}{23}
\subsubsectionoccurances{\bh{nišqå̄p̄}~/ \bh{hišqīp̄}}{22}
