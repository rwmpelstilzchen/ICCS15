...
\begin{paper}
	...
	As I’ve said \C{gweled} is used for simple sensory perception and ***, while \C{edrych} *** this includes facing (with indication of direction or without it), looking for (with \C{am}), accepting, examining etc.
\end{paper}
