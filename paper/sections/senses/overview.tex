...
\begin{paper}
	...
	What we’ll do now in the main part of the paper is to \hl{map} the Welsh equivalents Morgan chose for translating Hebrew phrases concerning the senses. The relationship between them can be of different types, like we’ve seen at point~A.
