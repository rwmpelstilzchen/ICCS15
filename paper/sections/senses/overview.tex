...
\begin{example}{Dan.}{5}{23}{}{}
	...
	{(Aramaic:) wlʾlhy kspʾ·wdhbʾ nḥšʾ przlʾ ʾʿʾ wʾbnʾ dy lʾ·\hlA{ḥzyn} wlʾ·\hlA{šmʿyn} wlʾ ydʿyn šbḥt}
...
\begin{hopoint}
	\begin{compactitem}
		\item \C{gweled} and \C{clywed}:
			\begin{compactitem}
				\item semantically unmarked concerte sensory perception
				\item perception of content
			\end{compactitem}
		\item \C{edrych} and \C{gwrando}:
			\begin{compactitem}
				\item \C{edrych}: facing, looking at or looking for, accepting, examining, inspecting, etc.
				\item \C{gwrando}: obeying, accepting, following, judging, interpreting, etc.
			\end{compactitem}
	\end{compactitem}
\end{hopoint}
