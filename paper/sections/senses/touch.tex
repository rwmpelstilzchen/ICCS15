...
\begin{paper}
	{\click} The verb \bh{må̄šaš} ‘to touch (by hand), to feel’ is translated in most cases using \C{teimlo}; this is the lexeme used in the list of modalities in \exvref{Ps.}{115}{4–7}{}. \C{palfalu} or \C{ymbalfalu} are used in verses concerning trying to grasp the environment in darkness or blindness. When in \exvref{Judg.}{16}{26}{} Samson asks the lad to let him feel the pillars, Morgan may foreshadow the later event by choosing to translate \bh{hămīšēnī} by \C{gad i mi gael gafel} (=\C{gafael}).
