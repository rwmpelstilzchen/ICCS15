...
\begin{paper}
	{\click} The verb \bh{må̄šaš} ‘to touch (by hand), to feel’ is translated in most cases using \C{teimlo}; this is the lexeme used in the list of modalities in \exvref{Ps.}{115}{4–7}{}. \C{palfalu} or \C{ymbalfalu} are used in verses concerning trying to grasp the surrounding environment in darkness or blindness. However, when in \exvref{Judg.}{16}{26}{} the blinded Samson asks the lad to let him feel the pillars, Morgan may foreshadow the later destruction event by choosing to translate \bh{hămīšēnī ʾɛṯ·hå̄·ʿammūḏīm} by \C{gad i mi gael gafel ar y colofnau} (=\C{gafael}) ‘let me to have a grip on the pillars’.
...
\begin{paper}
	The verb \bh{giššēš} has only one occurance in the Bible, which is similar in nature to \bh{må̄šaš} being used for grasping the environment in darkness or blindness; accordingly it is translated by \C{palfalu}.
\end{paper}
