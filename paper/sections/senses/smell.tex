...
\begin{paper}
	\bh{hērīaḥ} ‘to smell’ is usually translated using \C{arogli}, except when the Hebrew idiomatics seems not to be applicable in Welsh. Such are exx.~\vref{Judg.}{16}{9}{} and \vref{Judg.}{16}{9}{}, but it is quite possible Morgan was aided there by a mediating translation.
\end{paper}
...
\begin{paper}
	The noun \bh{rēaḥ} ‘smell’ is translated by \C{arogl}, with \C{aroglau} and \C{arogledd} as variation. The very common collocation \bh{rēaḥ nīḥōaḥ} ‘\tounfold{good smell}’, pertaining to the Ancient Hebrew religion, is translated by \C{arogl esmwyth}.
\end{paper}
