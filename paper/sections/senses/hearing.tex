...
\begin{paper}
	{\click} \bh{šåmaʿ} ‘to hear’ is the auditory equivalent of the visual \bh{råʾå}, serving as the principal verb of hearing.
...
\begin{paper}
	{\click} \bh{šåmaʿ} in the sense of \hl{judging}, of deciding one way or the other, or of asking God for judgement, is translated by \C{gwꝛando}.
\end{paper}
...
\begin{paper}
	The Hebrew idiom of ‘hearing a language’ in the sense of knowing it has no direct Welsh equivalent using either \C{clywed} or \C{gwrando}; so Morgan used \C{deall} ‘to understand’ instead.
\end{paper}
